...
E quindi il **29 settembre** (ovvero questo martedì, dopodomani) saremo io, [Leonardo Zizzamia](https://github.com/Zizzamia) e [Matteo Collina](https://github.com/mcollina), moderati da [Mattia Tommasone](https://github.com/raibaz), riuniti a parlare del perché contribuire a progetti open source renda sviluppatori migliori. La mia tesi di base, piccolo spoiler, è che renda sviluppatori migliori perché di base ci rende **persone migliori**.
